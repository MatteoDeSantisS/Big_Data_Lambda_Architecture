...
from pyspark.sql.functions import avg, col, dayofmonth, get_json_object, month, unix_timestamp, year
...
dataframe = dataframe \
            ...
            .groupBy('city', 'day', 'month', 'year', 'no2mean', 'eventdate') \
            .agg(avg('no2mean').alias('no2max')) \
            .select('city', 'day', 'month', 'year', 'no2mean', 'no2max', 'eventdate')
